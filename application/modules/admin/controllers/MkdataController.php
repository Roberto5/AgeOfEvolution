...
class Admin_MkdataController extends Zend_Controller_Action
{
    ...
    public function indexAction ()
    {
        ...
        $maxliv = Array('0' => 20, '1' => 20, '2' => 20, '3' => 20, '4' => 20, 
        '5' => 20);
        $content = "fattore di riduzione: {0}<br/>al prossimo livello: [0]<br/>";
        $Description = Array(
        ...
        array('rid' => $rid, 'cost' => $cost, 'maxliv' => $maxliv, 
        ...
        $require = Array('0' => Array('type' => 1, 'liv' => 5), 
        '1' => Array('type' => 5, 'liv' => 3), 'age' => '1');
        $maxliv = Array('0' => 20, '1' => 20, '2' => 20, '3' => 20, '4' => 20, 
        '5' => 20);
        ...
        $content = "capacit&agrave;: {0} <br/>al prossimo livello: [0]<br/>";
        ...
        $content = "produzione {0} <br/>al prossimo livello: [0]<br/>";
        $Description = Array(
        ...
        $content = "alloggi disponibili {0}<br/>al prossimo livello: [0]<br/>";
        $Description = Array(
        ...
        $param = Array('0' => "capacity");
        $maxliv = Array('0' => 6, '1' => 20, '2' => 20, '3' => 20, '4' => 20, 
        '5' => 20);
        ...
        for ($i = 0,$j=1; $i <= 20; $i ++,$j+=0.1)
            ...
            $i);
        $require = Array('0' => Array('type' => 2, 'liv' => 1), 
    '1' => Array('type' => 3, 'liv' => 1), 'age' => '1');
    ...
    '0' => "tenda del mercante permette di scambiare risorse con i tuoi villaggi e con il mercato");
        ...
        for ($i = 1; $i <= 20; $i ++)
            ...
            $i);
        $require = Array('0' => Array('type' => MAIN, 'liv' => 10),'age' => '1');
        $Description = Array(
    '1' => "il senato &egrave; il cuore del comando della tu&aacute; civilt&aacute;, da qui potrai colonizzare o conquistare altri villaggi. La costruzione rende capitale il villaggio in cui risiede.");
        ...
        for ($i = 0; $i <= 20; $i ++)
            ...
            $i);
        $content="punti ricerca disponibili: {0}<br/>al prossimo livello: [0]<br/>";
        $Description = Array(
        ...
        $maxliv = Array('0' => 0, '1' => 10, '2' => 15, '3' => 20, '4' => 20, 
        '5' => 20);
        $require=array(array('type'=>MAIN,'liv'=>5),'age'=>1);
