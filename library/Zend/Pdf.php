...
/** @to_do Section should be removed with ZF 2.0 release as obsolete            */
...
class Zend_Pdf
{
  /**** Class Constants ****/
     ...
     * Pages collection
     *
     * @to_do implement it as a class, which supports ArrayAccess and Iterator interfaces,
     ...
     *
     * @to_do atomatically attach page to the document, if it's not done yet.
     * @to_do check, that page is attached to the current document
     *
     * @to_do Dump pages as a balanced tree instead of a plain set.
     */
     ...
     *
     * @to_do Create a balanced tree instead of plain structure.
     */
     ...
     *
     * @to_do Give appropriate name and make method public
     *
     ...
     *
     * @to_do This really isn't the best location for this method. It should
     *   probably actually exist as Zend_Pdf_Element_Date or something like that.
     *
     * @to_do Address the following E_STRICT issue:
