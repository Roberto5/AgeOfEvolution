...
class Zend_Soap_Wsdl
{
    ...
    public function __construct($name, $uri, $strategy = true)
    {
        ...
        /**
         * @to_do change DomDocument object creation from cparsing to construxting using API
    ...
    public function setUri($uri)
    {
        ...
        if($this->_dom !== null) {
            // @to_do: This is the worst hack ever, but its needed due to design and non BC issues of WSDL generation
     ...
     *
     * @to_do Boolean is for backwards compability with extractComplexType object var. Remove it in later versions.
     * @param boolean|string|Zend_Soap_Wsdl_Strategy_Interface $strategy
     ...
     */
    public function to_domDocument()
    {
        return $this->_dom;
    }
