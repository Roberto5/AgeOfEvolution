    ...
    implements Zend_Cloud_StorageService_Adapter
{
     ...
     *
     * @to_do Support streams for those services that don't support natively
     *
    ...
    {
        try {
            // to_do We *really* need to add support for object copying in the S3 adapter
    ...
    {
        try {
            // to_do Support 'prefix' parameter for Zend_Service_Amazon_S3::getObjectsByBucket()
    ...
    protected function _getFullPath($path, $options)
    {
        ...
        if (isset($options[self::BUCKET_AS_DOMAIN])) {
            // to_do: support bucket domain names
            require_once 'Zend/Cloud/StorageService/Exception.php';
