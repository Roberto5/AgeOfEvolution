...
{
    // to_do: with an internal cache we could optimize this class, or create an extra class with
    ...
    public function removeMessage($id)
    {
        ...
        // to_do: expunge here or at close? we can handle an error here better and are more fail safe
    ...
    {
        // to_do: use search to find number directly
    ...
    {
        // to_do: we assume / as the hierarchy delim - need to get that from the folder class!
