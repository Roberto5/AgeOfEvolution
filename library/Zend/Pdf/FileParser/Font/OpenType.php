...
abstract class Zend_Pdf_FileParser_Font_OpenType extends Zend_Pdf_FileParser_Font
{
  ...
  /* Semi-Concrete Class Implementation */
    ...
    public function parse()
    {
        ...
        */
         ...
         */
        /**
         * @to_do Add parser for kerning pairs.
         * @to_do Add parser for ligatures.
         * @to_do Add parser for other useful hinting tables.
         */
    }
  ...
  /* Parser Methods */
    ...
    protected function _parseOs2Table()
    {
         ...
         */
        /**
         * @to_do Font is recognized as Adobe Latin subset font if it only contains
        ...
        /**
         * @to_do Obtain the x and capital heights from the 'glyf' table if they
     ...
     * characters.
     *
     * @to_do Need to rework the selection logic for picking a subtable. We should
