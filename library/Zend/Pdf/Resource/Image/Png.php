...
class Zend_Pdf_Resource_Image_Png extends Zend_Pdf_Resource_Image
{
     ...
     * @to_do Add compression conversions to support compression strategys other than PNG_COMPRESSION_DEFAULT_STRATEGY.
     * @to_do Add pre-compression filtering.
     * @to_do Add interlaced image handling.
     * @to_do Add support for 16-bit images. Requires PDF version bump to 1.5 at least.
     * @to_do Add processing for all PNG chunks defined in the spec. gAMA etc.
     * @to_do Fix tRNS chunk support for Indexed Images to a SMask.
     */
