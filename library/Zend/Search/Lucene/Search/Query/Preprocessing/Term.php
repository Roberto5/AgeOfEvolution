...
class Zend_Search_Lucene_Search_Query_Preprocessing_Term extends Zend_Search_Lucene_Search_Query_Preprocessing
{
    ...
    public function rewrite(Zend_Search_Lucene_Interface $index)
    {
        ...
        /** @to_do check for PCRE unicode support may be performed through Zend_Environment in some future */
        ...
        /**
         * @to_do Process $token->getPositionIncrement() to support stemming, synonyms and other
