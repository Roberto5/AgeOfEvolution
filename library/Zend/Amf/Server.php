 ...
 * Zend Framework
 *
 * @to_do       Make the reflection methods cache and autoload.
 * @package    Zend_Amf
 * @subpackage Server
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
...
class Zend_Amf_Server implements Zend_Server_Interface
{
   ...
   /**
     ...
     *
     * @to_do   should implement and SPL observer pattern for custom AMF headers
     * @to_do   DescribeService support
     ...
     * to_do: add support for prefixes?
     *
     * @param string $dir
     */
