 ...
 *
 * @to_do  Handle params with multiple values, e.g. --colors=red,green,blue
 ...
 *
 * @to_do  Handle params with multiple values specified with separate options
 ...
 *
 * @to_do  Handle flags occurring multiple times, e.g. -v -v -v
 ...
 *
 * @to_do  Handle flags that implicitly print usage message, e.g. --help
 *
 * @to_do  Handle freeform options, e.g. --set-variable
 *        Enable with Zend_Console_Getopt::CONFIG_FREEFORM_FLAGS
 *        All flag-like syntax is recognized, no flag generates an exception.
 *
 * @to_do  Handle numeric options, e.g. -1, -2, -3, -1000
 ...
 *
 * @to_do  Enable user to specify header and footer content in the help message.
 *
 * @to_do  Feature request to handle option interdependencies.
 *        e.g. if -b is specified, -a must be specified or else the
 *        usage is invalid.
 *
 * @to_do  Feature request to implement callbacks.
